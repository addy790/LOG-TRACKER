# -*- coding: utf-8 -*-
"""
Clean Single Assembler for index.html (GATE Tracker Pro)
"""
...
with open('assemble_index.py', 'w', encoding='utf-8') as f:
    f.write(f'HTML_HEAD = """{HTML_HEAD}"""\n')

print("assemble_index.py started")
