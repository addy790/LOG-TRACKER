# -*- coding: utf-8 -*-
"""
GATE Tracker Pro Builder Script
Generates the complete, production-grade index.html
"""
...
# Part 1: Head, Tailwind, Fonts, CSS
...
<body class="bg-slate-950 text-slate-100 font-sans min-h-screen h-screen overflow-hidden antialiased select-none">
''')

# Write out the full app python generator script
with open(r'C:\Users\adith\OneDrive\Desktop\Gate Notion Tracker\generate_tracker.py', 'w', encoding='utf-8') as f:
    f.write('''# -*- coding: utf-8 -*-
"""
GATE Tracker Pro Full Application Generator
Outputs index.html
"""
...
<body class="bg-slate-950 text-slate-100 font-sans min-h-screen h-screen overflow-hidden antialiased select-none flex">
      ...
      <div id="onboard-step-2" class="onboard-step space-y-6 relative z-10 hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" id="ob-name" placeholder="Aditya Sharma" class="w-full glass-input rounded-lg px-4 py-2.5 text-sm">
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" id="ob-air" placeholder="Top 50 / AIR < 100" class="w-full glass-input rounded-lg px-4 py-2.5 text-sm" value="AIR < 100">
          </div>
          <div>
            <label class="block text-xs font-semibold text-slate-300 mb-1.5">Target Marks (out of 100)</label>
            <input type="number" id="ob-target-marks" min="40" max="100" placeholder="78" class="w-full glass-input rounded-lg px-4 py-2.5 text-sm" value="80">
          </div>
          <div class="sm:col-span-2">
            ...
            <select id="ob-institute" class="w-full glass-input rounded-lg px-4 py-2.5 text-sm">
              <option value="IISc Bangalore (CSA / CDS)">IISc Bangalore (CSA / CDS)</option>
      ...
      <div id="onboard-step-6" class="onboard-step space-y-6 relative z-10 hidden text-center py-4">
        ...
        <div class="glass-panel p-4 rounded-xl max-w-md mx-auto grid grid-cols-3 gap-2 text-center text-xs">
          <div>
            ...
            <div id="ob-sum-target" class="font-bold text-white text-sm">AIR < 100</div>
          </div>
          <div>
            ...
            <div class="space-y-6">
              ...
              <div class="glass-panel p-5 rounded-2xl border border-white/10 space-y-4 text-center">
                ...
                <div class="pt-2 border-t border-white/5 flex items-center justify-between text-xs text-slate-400">
                  ...
                  <button onclick="logManualStudyTimeModal()" class="text-brand-400 hover:underline">+ Log Study Time</button>
                </div>
              </div>
  ...
  <!-- Core App Logic Script Included in Part 2 -->
...
print("generate_tracker.py written")
